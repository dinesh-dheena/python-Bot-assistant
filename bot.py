...
class MonApp(Tk):
    ...
    while n < 100:
        ...
        def __init__(self):
            ...
            self.configure(background='#AE60C9')
            self.geometry("500x500")
            self.btn1 = Button(self, text='click and speak',bg="#F9F624", command=self.traitement)
            self.btn1.place(x=205, y=250)
            label1=Label(self,text="BOT ASSISTANT",relief='solid',bg="#48EDD6", width=20,font=("arial",19,"bold"))
            label1.place(x=90,y=53)
            label2=Label(self,text="Developed with ❤ by Dinesh",relief='solid',bg="#48EDD6", width=32,font=("arial",19,"bold"))
            label2.place(x=9,y=415)
            label3=Label(self,text="Copyrights reserved © 2020",relief='solid',bg="#48EDD6", width=32,font=("arial",19,"bold"))
